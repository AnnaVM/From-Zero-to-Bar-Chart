...
The csv can be accessed [here](https://raw.githubusercontent.com/rcrocker13/From-Zero-to-Bar-Chart/master/data.csv). You should also be able to reference data.csv from your current working directory. If you're familar with [Let's Make a Bar Chart](https://bost.ocks.org/mike/bar/) then you'll recall manually input data used and a .tsv. To make things more familiar I converted the .tsv used in that guide into a .csv.
